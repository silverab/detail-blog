...
class ProfilePageForm(forms.ModelForm):
	...
	class Meta:
		model = Profile
		fields = ('bio', 'profile_pic', 'website_url', 'twitter_url', 'fb_url', 'pinterest_url', 'insta_url')
		widgets = {
...
class UserEditForm(UserChangeForm):
	...
	class Meta:
		model = User
		fields = ('username', 'first_name', 'email', 'password', 'last_login', 'is_superuser', 'is_staff', 'is_active', 'date_joined')
